...
% 24 - DoF(6) - Yaw position
    ...
    methods
        ...
        function[timestamp]=getStep(this,step,roverPointer,time)
            ...
            Xvelocity = this.Xvel;
            Yvelocity = this.Yvel;
            Ka = 10000;         % attraction constant
            Kr = -300000000;      % repulsion constant
        ...
        function[timestamp]=getStepPS(this,bestPosition,step,roverPointer,time)
            ...
            if (abs(frx) == Krep) % if the rover has reached the edge of the sarch space
                this.bestPosition = [0.5*edgeLength,0.5*edgeLength];
            end
